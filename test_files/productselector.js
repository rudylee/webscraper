$(function(){
	...
	$.getJSON("http://www.pfeiffer-vacuum.com/ajax/productselector.action?"+d,function(e){
	...
	$.getJSON("http://www.pfeiffer-vacuum.com/ajax/productselector.action?"+e,function(f){
	    window.setTimeout(function(){
